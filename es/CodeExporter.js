...
var codesandboxIcon = /*#__PURE__*/React.createElement("svg", {
  width: "20",
  height: "20",
  viewBox: "0 0 256 296",
  version: "1.1",
...
function getOperationNodes(query) {
  ...
  try {
    var _iterator = _createForOfIteratorHelper(parse(query).definitions),
      _step;
    try {
 ...
 */
export var ToolbarMenu = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ToolbarMenu, [{
    ...
    value: function render() {
      ...
      return (
        ...
        }, this.props.label, /*#__PURE__*/React.createElement("svg", {
          width: "14",
          height: "8"
        }, /*#__PURE__*/React.createElement("path", {
          fill: "#666",
...
var CodeExporter = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(CodeExporter, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }))), snippet.options.length > 0 ? /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      }), supportsCodesandbox ? /*#__PURE__*/React.createElement("div", {
        style: {
          padding: '0 7px 8px'
        }
      ...
      }, codesandboxIcon, ' ', /*#__PURE__*/React.createElement("span", {
        style: {
          paddingLeft: '0.5em'
        }
      }, "Create CodeSandbox")), codesandboxResult ? /*#__PURE__*/React.createElement("div", {
        style: {
          paddingLeft: 5,
          paddingTop: 5
        }
      }, codesandboxResult.type === 'loading' ? 'Loading...' : codesandboxResult.type === 'error' ? "Error: ".concat(codesandboxResult.error) : /*#__PURE__*/React.createElement("a", {
        rel: "noopener noreferrer",
        target: "_blank",
        href: "https://codesandbox.io/s/".concat(codesandboxResult.sandboxId)
      }, "Visit CodeSandbox")) : null) : null), /*#__PURE__*/React.createElement("button", {
        className: 'toolbar-button',
        style: {
          fontSize: '1.2em',
          padding: 0,
        ...
        pointerEvents: "none"
      }, "Copied!"), copyIcon), /*#__PURE__*/React.createElement("div", {
        style: {
          padding: '15px 12px',
          margin: 0,
      ...
      }, codeSnippet ? /*#__PURE__*/React.createElement(CodeDisplay, {
        code: codeSnippet,
        mode: snippet.codeMirrorMode,
        theme: this.props.codeMirrorTheme
      }) : /*#__PURE__*/React.createElement("div", null, "The query is invalid.", /*#__PURE__*/React.createElement("br", null), "The generated code will appear here once the errors in the query editor are resolved.")));
    }
  }]);
  return CodeExporter;
}(Component);
  ...
  _createClass(ErrorBoundary, [{
    ...
    value: function render() {
      if (this.state.hasError) {
        ...
        }, "Error generating code. Please", ' ', /*#__PURE__*/React.createElement("a", {
...
export default function CodeExporterWrapper(_ref4) {
  ...
  }, "Code Exporter"), /*#__PURE__*/React.createElement("div", {
  ...
  }, snippets.length ? /*#__PURE__*/React.createElement(ErrorBoundary, null, /*#__PURE__*/React.createElement(CodeExporter, {
    query: query,
    serverUrl: serverUrl,
    snippets: snippets,
    snippet: snippet,
